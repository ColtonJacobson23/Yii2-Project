    ...
    <div style="padding-left:80px; padding-right:80px;">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?= $form->field($model, 'current_password')->passwordInput()->label("Current Password - must be entered to make any changes on this page.") ?>
                <hr/>
                <div class="text-center secTitle">Username and Email</div>
                <?= $form->field($model, 'email') ?>
                <?= $form->field($model, 'username') ?>

                <hr/>
                <div class="text-center secTitle">Change Password</div>
